    ...
    <section className="panel group-panel">
      ...
      {showForm && (
        <form className="group-form" onSubmit={handleSubmit}>
          ...
          <label><span>群 ID</span><input aria-invalid={id.length > 0 && !isSafeId} maxLength={256} onChange={(event) => setId(event.target.value)} placeholder="conversationId / openConversationId" required value={id} /></label>
