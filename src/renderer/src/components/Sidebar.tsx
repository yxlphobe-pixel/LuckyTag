...
export type SectionId = 'overview' | 'knowledge' | 'reply' | 'dima' | 'app-config' | 'settings'
...
const items: Array<{ id: SectionId; label: string; icon: IconName }> = [
  ...
  { id: 'dima', label: 'Dima需求', icon: 'clipboard' },
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="brand-block">
        ...
        <div>
          <p className="brand-name">LuckyTag</p>
      ...
      <p className="build-label">LuckyTag · Reborn 0.3</p>
    </aside>
  )
}
