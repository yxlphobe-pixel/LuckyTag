...
// This fixture describes the selected model transport. It deliberately has a
// non-credential name because it never contains an API key value.
const CODEX_MODEL_TRANSPORT = {
  provider: 'custom',
